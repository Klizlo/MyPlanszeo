...
public interface BoardGameListService {
    ...
    List<BoardGameList> modifyBoardGameInBoardGameLists(Long gameId, List<Long> selectedLists, Long userId);
    ...
    default void changeBoardGameListState(Long boardGameListId, Long userId) {}
